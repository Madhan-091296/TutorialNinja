...
//
//     parameters {
//         string(name: 'BROWSER', choices: ['chrome', 'firefox', 'edge'], defaultValue: 'chrome', description: 'Browser name')
//         string(name: 'MARKER', choices: ['smoke', 'sanity', 'regression'], defaultValue: 'smoke', description: 'Marker name')
//         string(name: 'PARALLEL', choices: ['3', '4', '5'], defaultValue: '2', description: 'Marker name')
//     }
//
//     environment {
//         REPORT_DIR = "reports"
...
//                 bat 'call venv\\Scripts\\activate.bat && pytest -s -v -m ${MARKER} --alluredir=%ALLURE_RESULTS% -n ${PARALLEL} testCases\\ --browser ${BROWSER}'
//             }
//         }
//
